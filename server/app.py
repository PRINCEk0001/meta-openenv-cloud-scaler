...
Uses openenv.core.env_server.create_app if it's installed,
otherwise gracefully falls back to a hand-rolled FastAPI setup.
"""
...
try:
    ...
    log.info("Loaded app via openenv.core")
    ...
    log.info("openenv-core not found, falling back to local FastAPI setup")
